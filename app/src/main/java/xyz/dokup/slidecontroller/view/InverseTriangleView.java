 ...
 **/
public class InverseTriangleView extends View {
    private static final String TAG = InverseTriangleView.class.getSimpleName();
    private final InverseTriangleView self = this;
    ...
    public InverseTriangleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InverseTriangleView(Context context, AttributeSet attrs, int defStyleAttr) {
